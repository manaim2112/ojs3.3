...
class MostReadBlockPlugin extends BlockPlugin {
	...
	function getContents($templateMgr, $request = null) {
		...
		if (!is_array($mostReadBlockTitle)) $mostReadBlockTitle = array();
		$locale = AppLocale::getLocale();
		$blockTitle = !empty($mostReadBlockTitle[$locale]) ? $mostReadBlockTitle[$locale] : __('plugins.blocks.mostRead.settings.blockTitle');
