...
<div class="grid grid-cols-1 md:grid-cols-5 lg:grid-cols-8 xl:grid-cols-12 gap-4 lg:gap-6 container mx-auto px-3 md:px-4 lg:px-6">
	<div class="grid-col-1 order-2 md:order-1 md:col-span-1 lg:col-span-1 xl:col-span-2 my-10 px-2 md:px-0">
		...
		{if $articleMainHook|trim}
			<div class="aside-hook-wrap bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700 mb-4">
				<button type="button" class="aside-toggle w-full flex items-center justify-between p-3 text-left cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-colors rounded-lg" aria-expanded="false" aria-controls="article-related-hook">
				...
				<div id="article-related-hook" class="aside-body border-t border-gray-200 dark:border-gray-700 hidden">
	...
	<div class="grid-col-1 order-1 md:order-2 md:col-span-3 lg:col-span-6 xl:col-span-8 px-2 md:px-0">
		<div class="page page_article">
			...
			{if $similarArticles|trim}
				<div class="similar-articles-wrap bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700 my-4">
					<button type="button" class="similar-toggle w-full flex items-center justify-between p-3 text-left cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-colors rounded-lg" aria-expanded="false" aria-controls="article-similar-content">
						<span class="flex items-center gap-2">
					...
					<div id="article-similar-content" class="similar-body border-t border-gray-200 dark:border-gray-700 hidden">
	...
	<div class="grid-col-1 order-3 md:order-3 md:col-span-1 lg:col-span-1 xl:col-span-2 px-2 md:px-0">
