	...
	<div class="heading">
		...
		{if $issueCover}
			<a class="cover" href="{url op="view" page="issue" path=$issue->getBestIssueId()}">
				...
				{/capture}
				<img src="{$issueCover|escape}" alt="{$issue->getLocalizedCoverImageAltText()|escape|default:$defaultAltText}" onerror="this.src='https://placehold.co/300x400/f8f9fc/94a3b8?text=No+Cover'">
			</a>
		{/if}
