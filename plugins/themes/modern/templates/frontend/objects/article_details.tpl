 ...
 *
 * Modern theme — Article details with flags, orchid icon, and collapsible references.
 *}
 {if !$heading}
...
<article class="obj_article_details">
	...
	<div class="row">
		<div class="main_entry">
			...
			{* Authors with country flags and ORCID *}
						...
						<li>
							<span class="name">
								...
								{if $author->getData('country')}
									<img loading="lazy" src="https://flagcdn.com/w20/{$author->getData('country')|lower}.png" alt="{$author->getData('country')|escape}" class="modern-flag" width="12" height="8">
								{/if}
							</span>
							...
							{if $author->getData('orcid')}
								<span class="orcid">
									<a href="{$author->getData('orcid')|escape}" target="_blank" class="modern-orcid-link">
							...
							{if $author->getEmail()}
								<span class="author-email">
									<a href="mailto:{$author->getEmail()|escape}">
			...
			<section class="item keywords">
				...
				<span class="value">
					{foreach name="keywords" from=$publication->getLocalizedData('keywords') item="keyword"}
						<span class="keyword-tag">{$keyword|escape}</span>{if !$smarty.foreach.keywords.last} {/if}
					{/foreach}
				</span>
			</section>
			{/if}
			...
			{if $parsedCitations || $publication->getData('citationsRaw')}
				<section class="item references modern-refs-section">
					<button type="button" class="modern-refs-toggle" aria-expanded="false">
						<span>
							{translate key="submission.citations"}
							<span class="modern-refs-count">({if $parsedCitations}{$parsedCitations|count}{else}0{/if})</span>
						</span>
						<span class="fa fa-chevron-down modern-refs-chevron"></span>
					</button>
					<div class="modern-refs-body" style="display: none;">
						<div class="modern-refs-list">
							{if $parsedCitations}
								{foreach from=$parsedCitations item="parsedCitation"}
									<p class="modern-ref-item">{$parsedCitation->getCitationWithLinks()|strip_unsafe_html} {call_hook name="Templates::Article::Details::Reference" citation=$parsedCitation}</p>
								{/foreach}
							{else}
		...
		<div class="entry_details">
			...
			{* Article/Issue cover image with placeholder *}
					...
					<div class="sub_item">
						{if $publication->getLocalizedData('coverImage')}
							...
							<img
								...
								onerror="this.src='https://placehold.co/400x560/f8f9fc/94a3b8?text=No+Cover+Image'"
							>
						{else}
